...
if __name__ == "__main__":
    ...
    sorted_seq = profile_function(merge_sort, data, label="Sekwencyjny MergeSort")

    # Parallel MergeSort
    sorted_par = profile_function(parallel_merge_sort, data, max_depth, label="Równoległy MergeSort")
